...
export function CinematicHero({ 
  brandName = "Extrava",
  tagline1 = "Track infusions",
  tagline2 = "on the app.",
  cardHeading = "",
  cardDescription = <></>,
  metricValue = 365,
  metricLabel = "Days Monitored",
  ctaHeading = "Start monitoring.",
  ctaDescription = "Extrava aims to empower nursing teams with intelligent monitoring, helping to detect issues earlier.",
  className, 
  ...props 
}: CinematicHeroProps) {
// ...
// (Remove the div with floating-badge)
// (Inside phone-widget, keep phone-widget and phone mockup, remove extra overlay text)
// (Remove floating badge elements in the Mockup wrapper)
// (Simplify phone interface to only show the phone mockup)
